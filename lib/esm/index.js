...
var EasyCrop = forwardRef(function (props, ref) {
    ...
    var _c = useState({ unit: '%', width: 50, height: 50 }), crop = _c[0], setCrop = _c[1];
    var _d = useState(), completedCrop = _d[0], setCompletedCrop = _d[1];
    // @ts-ignore
    var _e = useState({ width: 0, height: 0 }), cropSize = _e[0], setCropSize = _e[1];
    var onCropComplete = useCallback(function (crop) {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(ReactCrop, __assign({}, cropperProps, { src: src, crop: crop, ruleOfThirds: true, onImageLoaded: onLoad, onChange: function (c) { return setCrop(c); }, onComplete: function (c) { return onCropComplete(c); }, classes: { containerClassName: pkg + "-container", mediaClassName: MEDIA_CLASS } })),
        React.createElement("div", null,
            React.createElement("canvas", { id: "previewCanvas", ref: previewCanvasRef, 
...
export var ZegImgCrop = forwardRef(function (props, ref) {
    ...
    var _a = useState(''), src = _a[0], setSrc = _a[1];
    var _b = useState(1), zoomVal = _b[0], setZoomVal = _b[1];
    var _c = useState(0), rotateVal = _c[0], setRotateVal = _c[1];
    ...
    // @ts-ignore
    var onComplete = useCallback(function (naturalImg, crop) {
    ...
    console.log('OLA');
    var renderComponent = function (titleOfModal) { return (React.createElement(React.Fragment, null,
        renderUpload(),
        src && (React.createElement(Modal, __assign({ visible: true, wrapClassName: pkg + "-modal", title: titleOfModal, onOk: onOk, onCancel: onClose, maskClosable: false, destroyOnClose: true }, modalProps),
            React.createElement(EasyCrop, { ref: ref, src: src, aspect: aspect, shape: shape, grid: grid, hasZoom: hasZoom, zoomVal: hasZoom, rotateVal: rotateVal, setZoomVal: setZoomVal, setRotateVal: setRotateVal, minZoom: minZoom, maxZoom: maxZoom, onComplete: onComplete, cropperProps: cropperProps }),
            hasZoom && (React.createElement("div", { className: pkg + "-control zoom" },
            ...
            hasRotate && (React.createElement("div", { className: pkg + "-control rotate" },
    ...
    return (
    // @ts-ignore
    React.createElement(LocaleReceiver, null, function (locale, localeCode) { return renderComponent(localeCode === 'zh-cn' ? '编辑图片' : 'Edit image'); }));
});
